...
import marsBackdrop from "@/assets/mars-space-bg.jpg";
...
function RootComponent() {
  ...
  return (
    <QueryClientProvider client={queryClient}>
      <div
        className="mars-backdrop"
        style={{ backgroundImage: `url(${marsBackdrop})` }}
        aria-hidden="true"
      />
